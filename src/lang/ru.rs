...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Import server config", "Импортировать конфигурацию а"),
        ("Export Server Config", "Экспортировать конфигурацию а"),
        ("Import server configuration successfully", "Конфигурация а успешно импортирована"),
        ("Export server configuration successfully", "Конфигурация а успешно экспортирована"),
        ("Invalid server configuration", "Неправильная конфигурация а"),
        ...
        ("server_not_support", "Пока не поддерживается ом"),
        ...
        ("Failed to connect to rendezvous server", "Невозможно подключиться к промежуточному у"),
        ...
        ("Failed to connect via rendezvous server", "Невозможно подключиться через промежуточный "),
        ...
        ("setup_server_tip", "Обращаться по телефону 89881454431, Техподдержка ITWOnline"),
